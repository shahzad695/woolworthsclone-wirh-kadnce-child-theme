...
/***/ "./assets/src/js/savetoProductsList.js"
/*!*********************************************!*\
  !*** ./assets/src/js/savetoProductsList.js ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
document.addEventListener("click", function (e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(woolworthSave.ajaxUrl, data).then(response => {
    const res = response.data;
    console.log(res);
    if (!res.success) return;
    btn.classList.toggle("is-saved", res.data.state === "added");
    btn.textContent = res.data.state === "added" ? "Saved to list" : "Save to list";
  }).catch(error => {
    console.error(error);
  });
});
...
/* harmony import */ var _js_savetoProductsList_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/savetoProductsList.js */ "./assets/src/js/savetoProductsList.js");
